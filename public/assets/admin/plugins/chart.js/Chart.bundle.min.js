...
module.exports = function(Chart) {
	 ...
	 * are drawn in the reverse orders). If any plugin returns `false`, the datasets drawing
	 ...
	 * (datasets are drawn in the reverse orders). Note that this hook will not be called
