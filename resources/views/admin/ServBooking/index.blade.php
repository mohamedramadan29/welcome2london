        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/   حجوزات الخدمات   </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label">  حجوزات الخدمات </div>
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($bookings  as $book)
                                    <tr>
                                        ...
                                        <td> {{$book['email']}} </td>
                                        <td> {{$book['phone']}} </td>
                                        <td> {{$book['serv_name']}} </td>
                                        <td> {{$book['travel_price']}} </td>
                                        ...
                                        <td>
                                            <a href="{{url('admin/bookingservices/update/'.$book['id'])}}"
                                    ...
                                    @include('admin.ServBooking.delete')
                                @endforeach
                                </tbody>
                            </table>
                        </div>
