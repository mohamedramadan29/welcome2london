...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/   مشاهدة وتعديل حجز الخدمة </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="mb-4 main-content-label">    مشاهدة وتعديل حجز الخدمة  </div>
                    <form class="form-horizontal" method="post" action="{{url('admin/bookingservices/update/'.$book['id'])}}"
