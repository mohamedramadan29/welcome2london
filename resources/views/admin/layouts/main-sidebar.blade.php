...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="">
                    ...
                    <span class="side-menu__label">  الحجوزات  </span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{url('admin/booking')}}"> حجوزات التنقلات   </a></li>
            ...
            <li class="side-item side-item-category"> الاعدادات العامة للموقع </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="">
                    <i style="font-size: 22px;margin-left: 10px" class="fa fa-folder-open"></i>
                    <span class="side-menu__label"> لاعدادات العامة للموقع </span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{url('admin/public_setting')}}"> مشاهدة التفاصيل   </a></li>
                </ul>
            </li>
